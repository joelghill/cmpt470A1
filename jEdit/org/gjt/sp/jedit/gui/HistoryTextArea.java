 ...
 * @author Slava Pestov
 * @version $Id: HistoryTextArea.java 5136 2004-10-17 04:36:32Z spestov $
 */
public class HistoryTextArea extends JTextArea
{
	...
	public HistoryTextArea(String name)
	{
		...
		Set<KeyStroke> focusForwardTraversalKeys = new TreeSet<KeyStroke>();
		focusForwardTraversalKeys.add(
			KeyStroke.getKeyStroke(KeyEvent.VK_TAB,0));
		Set<KeyStroke> focusBackwardTraversalKeys = new TreeSet<KeyStroke>();
